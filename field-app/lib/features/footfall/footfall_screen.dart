...
class _FootfallScreenState extends State<FootfallScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (count < 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Patient count must be ≥ 0'), backgroundColor: kColorDanger));
      return;
    }
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: const Text('Footfall logged. Will sync when online.'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Footfall Log', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('New Entry', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: kColorTextPrimary)),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.people_alt_rounded, color: kColorAccent),
                ),
              ),
              const SizedBox(height: 12),
              // Department dropdown
              if (_departments.isNotEmpty)
                DropdownButtonFormField<String?>(
                  ...
                  decoration: const InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.domain_rounded, color: kColorAccent),
                  ),
                  items: [
                    const DropdownMenuItem(value: null, child: Text('All departments', style: TextStyle(color: kColorTextMuted))),
              ...
              ElevatedButton.icon(
                ...
                label: Text(_saving ? 'Saving…' : 'Log Footfall'),
              ),
            ]),
          ),
          ...
          if (_recentLogs.isNotEmpty) ...[
            const Text('Recent Entries', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: kColorTextMuted, letterSpacing: 1)),
              ...
              child: Container(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('${log.patientCount} patients', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: kColorTextPrimary)),
                  ...
                  Container(
                    ...
                    child: const Text('saved', style: TextStyle(fontSize: 10, color: kColorAccent, fontWeight: FontWeight.w600)),
                  ),
                ]),
              ),
            )),
